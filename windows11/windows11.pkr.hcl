...
locals {
  ...
  vm_name_windows_11_pro        = "${ var.vm_guest_os_family }-${ var.vm_guest_os_version }-${ var.vm_guest_os_edition_pro }-${ local.build_version }"
...
source "vsphere-iso" "windows-11-pro" {
  ...
  content_library_destination {
      ...
      name                    = local.vm_name_windows_11_pro
  ...
  vm_name              = local.vm_name_windows_11_pro
  ...
  cd_content = {
    "autounattend.xml" = templatefile("${abspath(path.root)}/config/auto.pkrtpl.hcl", {
      ...
      vm_inst_os_image     = var.vm_inst_os_image_11_pro
